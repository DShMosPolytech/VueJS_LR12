<template>
  <div id="app">
    <div>
      <div>
        <label>Фамилия <input type="text" v-model="contNow.surname"></label>
      </div>
      <div>
        <label>Имя <input type="text" v-model="contNow.name"></label>
      </div>
      <div>
        <label>Отчество <input type="text" v-model="contNow.otchestvo"></label>
      </div>
      <div>
        <label>Телефон <input type="text" v-model="contNow.phone"></label>
      </div>
      <div>
